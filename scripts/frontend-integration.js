 ...
 * This file demonstrates how to integrate Meldwane with a web frontend
 */

// For React/Vue/Angular applications
export class MeldwaneClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MeldwaneClient(provider, contractAddress);
